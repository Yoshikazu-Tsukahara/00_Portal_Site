...
/**
 * ランチ貯金と同様:
 * - body にネイティブ操作向けクラスを付与
 * - standalone 時は履歴バックでポータルへ戻るのを抑止
 */
export default function LinkStockerPwaEffects() {
  ...
  useEffect(() => {
    ...
    const lockHistory = () => {
      window.history.pushState({ linkStockerPwa: 1 }, "", window.location.href);
    };
    lockHistory();
