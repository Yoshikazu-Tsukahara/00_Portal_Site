...
export const imageCompressorJa: ImageCompressorDict = {
  ...
  install: {
    ...
    buttonShort: "インストール",
    buttonTiny: "インストール",
    buttonAria: "画像一括軽量化をインストールして、個別アプリとして使う",
    modalTitle: "アプリをインストール",
    modalLead:
      "対応ブラウザからインストールすると、画像一括軽量化だけを個別アプリとしてすぐ開けます。",
    step1Title: "共有をタップ",
...
export const imageCompressorEn: ImageCompressorDict = {
  ...
  install: {
    ...
    buttonShort: "Install",
    buttonTiny: "Install",
    buttonAria: "Install Batch Image Compressor as a standalone app",
    modalTitle: "Install app",
    modalLead:
      "Install Batch Image Compressor from Safari to open it as a standalone app.",
