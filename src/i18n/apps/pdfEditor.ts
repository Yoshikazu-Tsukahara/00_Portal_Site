...
export const pdfEditorJa: PdfEditorDict = {
  ...
  install: {
    ...
    buttonShort: "インストール",
    buttonTiny: "インストール",
    buttonAria: "PDF編集をインストールして、個別アプリとして使う",
    modalTitle: "アプリをインストール",
    modalLead:
      "対応ブラウザからインストールすると、PDF編集だけを個別アプリとしてすぐ開けます。",
    step1Title: "共有をタップ",
...
export const pdfEditorEn: PdfEditorDict = {
  ...
  install: {
    ...
    buttonShort: "Install",
    buttonTiny: "Install",
    buttonAria: "Install PDF Editor as a standalone app",
    modalTitle: "Install app",
    modalLead:
      "Install PDF Editor from Safari to open it as a standalone app.",
